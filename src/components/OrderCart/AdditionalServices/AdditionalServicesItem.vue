<template>
  <li class="add-service__item">
    ...
    <div class="add-service__right">
      ...
      <div class="add-service__link"><a :href="workshop.url ? workshop.url : '#'" target="_blank">{{workshop.availability ? $t('message.orderCart.orderCartWorkshops.link.more') : $t('message.orderCart.orderCartWorkshops.link.site')}}</a></div>
    </div>
  </li>
</template>
